package com.example.tugasday7.ui;
...
import com.example.tugasday7.data.response.CustomerReviewsItem;
import com.example.tugasday7.data.response.PostReviewResponse;
import com.example.tugasday7.data.response.Restaurant;
import com.example.tugasday7.data.response.RestaurantResponse;
import com.example.tugasday7.data.retrofit.ApiConfig;
import com.example.tugasday7.R;
import com.example.tugasday7.databinding.ActivityMainBinding;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void postReview(String review) {
        showLoading(true);
        Call<PostReviewResponse> client = ApiConfig.getApiService().postReview(RESTAURANT_ID,"Jack", review);
